...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_set(20, 0, 100.0);         // Fwd/rev constants, used for odom and non odom motions
  ...
  chassis.pid_drive_exit_condition_set(90_ms, 1_in, 750_ms, 5_in, 500_ms, 500_ms);
...
void redSoloAWP(){
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(-14, DRIVE_SPEED*0.9);
  leftDoinker.toggle();
  chassis.pid_wait_quick_chain();
  pros::delay(100);
  clamp1.toggle();
  setIntake(127, 10);
  //baker
  chassis.pid_turn_relative_set(-166, TURN_SPEED);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_drive_set(6, DRIVE_SPEED);
  chassis.pid_wait_quick_chain();
  chassis.pid_turn_relative_set(72, TURN_SPEED*0.7);
  chassis.pid_wait_quick_chain();
  nextState();
  clamp1.toggle();
  //score on alliance stake
  chassis.pid_drive_set(6.75, DRIVE_SPEED);
  chassis.pid_wait_quick_chain();
  chassis.pid_turn_relative_set(-61, TURN_SPEED);
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(10, DRIVE_SPEED);
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set((190 - yDistanceSensor.get()), DRIVE_SPEED);
  chassis.pid_wait_quick_chain();
  pros::delay(100);
  setIntake(0, 0);
  lbUntip();
  ...
  rightDoinker.toggle();
  pros::delay(250);
  chassis.pid_drive_set(-15, DRIVE_SPEED*0.75);
  chassis.pid_wait_quick_chain();
  chassis.pid_turn_relative_set(-20, TURN_SPEED);
  chassis.pid_wait_quick_chain();
  //clamp 2nd goal
...
void redSoloAWPBaker(){
  ...
  chassis.pid_wait_quick_chain();
  //get 3rd ring (top ring in front of alliance stake)
  chassis.pid_turn_relative_set(-85, TURN_SPEED);
  chassis.pid_wait_quick_chain();
  rightDoinker.toggle();
  pros::delay(100);
  chassis.pid_turn_relative_set(8, TURN_SPEED);
  setIntake(127, 127);
  chassis.pid_wait_quick_chain();
